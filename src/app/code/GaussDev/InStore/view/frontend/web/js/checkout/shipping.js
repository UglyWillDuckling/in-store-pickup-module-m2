        ...
        return Component.extend({
            ...
            initialize: function () {
                ...
                this.isInStorePickup = ko.computed(function(){
                    ...
                    if(quote.shippingMethod()){
                        return quote.shippingMethod().method_code == "instore";
                    }
            ...
            isSelected: ko.computed(function () {
                    return quote.shippingMethod() ?
                        quote.shippingMethod().carrier_code + '_' + quote.shippingMethod().method_code : null;
                }
            ),
            ...
            /*
            * in case the user selected the in store shipping method
            * we need to check if she or he saved their own addresses and make them unavailable
            * */
            showShippingAddress: ko.computed(function(el){

                if(quote.shippingMethod() && !(addressList().length == 0))
                {
                    return !(quote.shippingMethod().method_code == "instore");
                }
